...
const TopBar: React.FC<TopBarProps> = ({
    ...
    return (
        <>
            <header className="flex items-center gap-4 px-3 md:px-5 h-[var(--header-height)] border-b border-apple-border/60 dark:border-white/10 animate-slide-in-from-bottom bg-apple-bg/80 dark:bg-zinc-900/80 backdrop-blur-md sticky top-0 z-30 transition-all duration-300" style={{ animationDelay: '0.1s' }}>
